...
\begin{remark}
The above axioms are weaker than ZFC, to have equivalence we require a final axiom. It allows for the existence of the universe created by $N$ and the power set function $\mathcal{P}(S) = \mathbf{2}^S$. We state if informally:
\end{remark}
